      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.22)] md:flex md:items-center md:justify-between md:gap-8 md:p-8">
          ...
          <a
            ...
            className="mt-6 inline-flex min-h-[50px] w-full items-center justify-center rounded-full border border-white/15 px-6 py-3 text-sm font-semibold text-white transition-all duration-200 hover:border-gold hover:text-gold active:scale-95 md:mt-0 md:w-auto"
          >
            Google Yorumlarımızı İnceleyin
          </a>
        </div>
      </div>
    </section>
