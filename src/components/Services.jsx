      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-5 xl:grid-cols-3">
          {siteContent.services.map((service) => (
            <article
              key={service.title}
              className="flex h-full flex-col rounded-[28px] border border-black/8 bg-white p-6 shadow-[0_14px_34px_rgba(10,10,10,0.05)] transition hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(10,10,10,0.08)] sm:p-7 md:p-8"
            >
              ...
              <a
                ...
                className="mt-6 inline-flex min-h-[50px] w-full items-center justify-center rounded-full bg-gold px-5 py-3 text-sm font-semibold text-black transition hover:bg-[#b89655] hover:shadow-md sm:w-fit"
              >
