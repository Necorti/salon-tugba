...
export default function Footer({ siteContent }) {
  return (
    <footer className="mt-16 border-t border-white/10 bg-primary py-14 text-white md:py-16">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 md:grid-cols-[1.15fr_1fr_0.9fr] md:gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-sm leading-7 text-white/78">
            <a
              ...
              className="block min-h-[48px] rounded-2xl px-4 py-3 transition-all duration-200 hover:bg-white/5 hover:text-gold"
            >
          ...
          <div className="flex flex-col gap-3 text-sm text-white/78">
            {quickLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="flex min-h-[48px] items-center rounded-2xl px-4 transition-all duration-200 hover:bg-white/5 hover:text-gold"
              >
                {link.label}
              </a>
            ))}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-[48px] w-full items-center justify-center rounded-full border border-white/15 px-5 py-3 text-sm font-semibold text-white transition-all duration-200 hover:border-gold hover:text-gold active:scale-95 sm:w-fit"
            >
      ...
      <div className="mx-auto mt-10 flex max-w-6xl flex-col gap-3 border-t border-white/10 px-4 pt-6 text-xs uppercase tracking-[0.18em] text-white/45 sm:px-6 md:flex-row md:items-center md:justify-between">
